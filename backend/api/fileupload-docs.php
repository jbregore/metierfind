...
if(isset($_FILES['comp-img-file'])){
	$file = $_FILES['comp-img-file'];
	$filename = $_FILES['comp-img-file']['name'];
	$fileTmpName = $_FILES['comp-img-file']['tmp_name'];
	$fileSize = $_FILES['comp-img-file']['size'];
	$fileError = $_FILES['comp-img-file']['error'];
	$fileType = $_FILES['comp-img-file']['type'];
