...
<head>
	...
	<!--css-->
	<link rel="stylesheet" type="text/css" href="assets/css/employer-jobseekeers-application.css">
	</link>
...
<body>
			...
			<div class="navbar">
				...
				<nav>
					<ul id="menuItems">
						...
						<li><a href="employer-jobseekers-application.php" class="active">Job Applicants</a></li>
	...
	<div class="categories" id="my-categories">
		<div class="small-container">
			...
			<div class="row" id="fetch-jobseekers">
	...
	<script src="assets/js/employer-jobseeker-application.js"></script>
</body>
