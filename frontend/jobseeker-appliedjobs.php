...
<head>
	...
	<!--css-->
	<link rel="stylesheet" type="text/css" href="assets/css/jobseeker-appliedjobs.css">
	</link>
...
<body>
			...
			<div class="navbar">
				...
				<nav>
					<ul id="menuItems">
						...
						<li><a href="jobseeker-appliedjobs.php" class="active">Applied Jobs</a></li>
		...
		<div class="small-container">
			...
			<!-- <div class="row">
				...
				<div class="col-30">
					...
					<div class="buttons">
						<button class="apply-job-btn" disabled>Applied</button>
					</div>
				</div>
	...
	<script src="assets/js/jobseeker-appliedjobs.js"></script>
